...
//        codec_info->clock_rate = 8000;
	...
	if (dir == PJMEDIA_DIR_ENCODING_DECODING) {
            PJ_LOG(4,(THIS_FILE,"%s: PJMEDIA_DIR_ENCODING_DECODING", __FUNCTION__));
            ...
            PJ_LOG(4,(THIS_FILE,"%s: PJMEDIA_DIR_ENCODING", __FUNCTION__));
	    status = pjmedia_snd_port_create_rec(pool, -1, 
            ...
            PJ_LOG(4,(THIS_FILE,"%s: PJMEDIA_DIR_DECODING", __FUNCTION__));
